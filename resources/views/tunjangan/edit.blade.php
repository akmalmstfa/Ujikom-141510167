...
@section('content')
            <div class="card">
                ...
                <div class="content">
                {!! Form::model($tunjangan,['class' => 'form-horizontal', 'method' => 'PATCH', 'route' => ['tunjangan.update',$tunjangan->id]]) !!}
                        ...
                        <div class="col-md-6">
                            <select name="golongan_id" id="golongan_id" class="form-control">
                                @foreach($golongans as $golongan)
                                    @if (Input::old('golongan_id') == $golongan->Jabatan->id.'|'.$golongan->Golongan->id ||  $tunjangan->Jabatan->id.'|'.$tunjangan->Golongan->id == $golongan->Jabatan->id.'|'.$golongan->Golongan->id)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select name="status" id="status" class="form-control">
                                @if(is_null(Input::old('status')))
                                    @if ($tunjangan->Status == 'Lajang')
                                        <option value="Lajang" selected>Lajang</option>
                                    @else
                                        <option value="Lajang">Lajang</option>
                                    @endif

                                    @if ($tunjangan->Status == 'Menikah' )
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            @if(is_null(old('besaran_uang')))
                            <input type="number" value="{{ $tunjangan->Jumlah_anak }}" name="jumlah_anak" class="form-control" >
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            @if(is_null(old('besaran_uang')))
                            <input type="text" name="besaran_uang" value="{{ $tunjangan->Besaran_uang }}" id="besaran_uang" class="form-control" >
                            @else
